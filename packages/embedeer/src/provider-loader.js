 ...
 *   @embedeer/ort-linux-x64-cuda   — CUDA on Linux x64
 *   @embedeer/ort-win32-x64-cuda   — CUDA on Windows x64
 *   @embedeer/ort-win32-x64-dml    — DirectML on Windows x64
 *
...
export const PROVIDER_PACKAGES = {
  'linux-x64-cuda':  '@embedeer/ort-linux-x64-cuda',
  'win32-x64-cuda':  '@embedeer/ort-win32-x64-cuda',
  'win32-x64-dml':   '@embedeer/ort-win32-x64-dml',
};
