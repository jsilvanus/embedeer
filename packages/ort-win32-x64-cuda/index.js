...
/**
 * Activate the CUDA provider on Windows x64.
...
export async function activate() {
  if (!existsSync(BINARY_PATH)) {
    throw new Error(
      `@embedeer/ort-win32-x64-cuda: native CUDA binary not found at ${BINARY_PATH}. ` +
      `Re-run: npm install @embedeer/ort-win32-x64-cuda`,
    );
  }
