...
> ⚠️ **MIGRATION NOTICE**: This repository has been migrated to the monorepo at [`jsilvanus/deer`](https://github.com/jsilvanus/deer). This repository will be archived and removed shortly. Please update your imports to use `@jsilvanus/embedeer` from the monorepo instead. Development and maintenance will continue only in the monorepo.
